...
public class MyBaseAllChatFragment extends EaseBaseFragment implements EMMessageListener {
    ...
    protected MyBaseAllChatFragment.MyItemClickListener extendMenuItemClickListener;
