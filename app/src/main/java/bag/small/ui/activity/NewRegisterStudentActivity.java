...
public class NewRegisterStudentActivity extends BaseActivity {
    ...
    //    @BindView(R.id.ac_new_student_head_iv)
//    ImageView acNewStudentHeadIv;
//    @BindView(R.id.new_register_student_name_tv)
//    TextView studentNameTv;
//    @BindView(R.id.new_register_student_type_tv)
//    TextView studentTypeTv;
//    @BindView(R.id.new_register_student_school_tv)
//    TextView studentSchoolTv;
//    @BindView(R.id.new_register_student_number_tv)
//    TextView studentNumberTv;
//    @BindView(R.id.new_register_student_class_tv)
//    TextView studentClassTv;
//    @BindView(R.id.new_register_student_class_student_tv)
//    TextView studentxuehaoTv;
//    @BindView(R.id.new_register_student_birthday_tv)
//    TextView studentBirthdayTv;
//    @BindView(R.id.new_register_student_gender_tv)
