...
public class ParentInformationActivity extends BaseActivity {
    ...
    @BindView(R.id.activity_student_name_edt)
    EditText pStudentNameEdt;
    @BindView(R.id.activity_student_number_edt)
    ...
    @BindView(R.id.activity_study_school_tv)
    TextView pStudySchoolTv;
    @BindView(R.id.activity_study_school_ll)
    LinearLayout pStudySchoolLl;
    @BindView(R.id.activity_study_num_tv)
    TextView pStudyNumTv;
    @BindView(R.id.activity_study_num_ll)
    LinearLayout pStudyNumLl;
    @BindView(R.id.activity_grade_tv)
    TextView pGradeTv;
    @BindView(R.id.activity_grade_ll)
    LinearLayout pGradeLl;
    @BindView(R.id.activity_class_tv)
    TextView pClassTv;
    @BindView(R.id.activity_class_ll)
    ...
    @BindView(R.id.activity_parent_name_edt)
    EditText pParentNameEdt;
    @BindView(R.id.activity_parent_phone_edit)
    EditText pParentPhoneEdit;
    @BindView(R.id.activity_parent_verification_code_edt)
    EditText verifyCodeEdit;
    @BindView(R.id.activity_teacher_send_code_btn)
    Button senCodeBtn;
    @BindView(R.id.activity_parent_commit_btn)
    Button pParentCommitBtn;
    @BindView(R.id.activity_student_gender_tv)
    TextView pGenderTv;
    @BindView(R.id.activity_student_gender_ll)
