...
public class RItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public RItemDecoration(int space) {
        this.space = space;
    }

    public RItemDecoration(int space, int color) {
        this.space = space;
        this.color = color;
    ...
    public RItemDecoration(int space, int color, int type) {
        this.space = space;
        this.color = color;
        mPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mPaint.setColor(color);
    ...
    public RItemDecoration(int space, Drawable mDivider) {
        this.space = space;
